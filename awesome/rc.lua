...
run_once({ "urxvtd", "unclutter -root", "picom", "nm-applet" }) -- comma-separated entries
...
beautiful.useless_gap = 5 -- Gap between apps
...
globalkeys = mytable.join(
    ...
    awful.key({  }, "Print", function() os.execute("maim ~/Pictures/$(date).png") end,
    ...
    awful.key({ winkey, "Control" }, "m",
        function ()
            os.execute(string.format("amixer -q set Master 100%%"))
        end,
        {description = "volume 100%", group = "hotkeys"}),
    awful.key({ winkey, "Control" }, "0",
        function ()
            os.execute(string.format("amixer -q set Master 0%%"))
        end,
    ...
    awful.key({ modkey }, "q", function () awful.spawn(browser) end,
              {description = "run browser", group = "awesome"}),
